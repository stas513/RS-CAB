...
const CarDocumentItem = ({ title, name, doc, id, carId, setDriverData }) => {
    ...
    try {
      ...
      if (file) {
        ...
        const res = await axios.put(
          `/api/users/driver/${id}/cars/${carId}/documents/`,
          formData,
          {
            headers: {
        ...
        if (res.status === 200) {
          ...
          setDriverData((prev) => ({
            ...prev,
            car: { ...prev.car, carDocument: res.data.data },
          }));
          setLoading(false);
        ...
        {loading ? (
          ...
          <>
            <label className="flex justify-end">
              <p className="font-poppins text-sm text-blue cursor-pointer">
            ...
            <div className="flex justify-end gap-3">
              <p
                className={`uploaded-file-name font-poppins text-xs ${
...
export default CarDocumentItem;
