...
import PassengersQuickEditForm from "./passengers-quick-edit-form";
    ...
    <>
      <TableRow hover selected={selected}>
        <TableCell sx={{ display: "flex", alignItems: "center" }}>
          <Avatar alt={row?.userInfo?.firstName} src={row?.profileImage} sx={{ mr: 2 }} />
